...
const Navbar = (props) => {
    ...
    library.add(faRightFromBracket,faBars,faUser)
        ...
        <div className='navbar'>
            <div className='navbar-content'>
                <div className='logo-name'>
                    ...
                    <h2 className='main-name' onClick={()=>{navigate("/home")}} style={{cursor: 'pointer'}} >Read It Again</h2>
                </div>
                <div className='user-options'>
                    <h3 className='profile' onClick={() => navigate('/profile')}><FontAwesomeIcon icon="fa-solid fa-user"/></h3>
